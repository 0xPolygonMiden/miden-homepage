...
const markdown = `
Miden achieves these features by using the full power of zero-knowledge (ZK) proofs. In this blog post, we are going to explain how privacy and scalability go hand in hand, and how true scalability requires privacy in a decentralized context. We will also explain how Miden users can execute Turing-complete privacy-preserving smart contracts, which is rare in the L2 landscape.

“Privacy” and “privacy-enhancing” are frequently used when describing blockchain technology. These terms have also appeared throughout this series of blog posts about Miden. It’s helpful, therefore, to set out a framework for understanding degrees of privacy and how Miden’s design aims to achieve real privacy. 
...
1. No Privacy: Complete transparency where everyone has access to all information.
2. Web2-like Privacy: Only transaction participants and operators have full visibility.
3. Strong Privacy: Only the transaction participants have full visibility.
4. Absolute Privacy: No party has visibility into all transaction data.
...
Privacy is not a secondary effect of the overall design of Miden. Privacy is its core feature, a benefit for applications and their users, and likely one of the missing pieces for broad adoption of blockchain technology.
