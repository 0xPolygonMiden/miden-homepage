...
Explore → Build → Propose
Funding: $20,000 grant
This phase is about validating your idea and building early traction.

**<Highlight>What to expect</Highlight>**
- Choose your direction: Use our Lighthouse examples for inspiration or pitch something new.
- Register your team: Contact us to sign up as an aspiring Pioneer.
- Build a PoC: Create a proof-of-concept over three weeks.
- Submit a proposal: Outline your project vision and technical approach.
- Evaluation: The Miden team will review your submission.
- Legal Agreement & Subsequent Funding: Upon approval, sign legal docs for funding and receive a $20,000 grant (independent of whether you continue to Phase 2).


### Phase 2 – Miden Pioneers

Build → Launch → Scale
Funding: Up to $300,000 in milestone-based grants
Teams that show strong promise in Phase 1 will be invited to join the full Pioneer Program.
...
- Ready to build the future of on-chain economies?
